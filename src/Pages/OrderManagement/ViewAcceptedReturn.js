  ...
  useEffect(() => {
    const fetchPurchaseData = async () => {
      try {
        ...
        if (purchase.receipt) {
          setFile({ name: purchase.receipt, isExisting: true }); // only store name
        }
            ...
            <div className="container-fluid">
              <div className="row mb-2">
                <div className="col-sm-6">
                  <h1 className="all-heading">View Accept Return Order</h1>
                </div>
              </div>
            </div>
          </section>
                      ...
                      <div className="col-md-12">
                        ...
                        {selectedProducts.length > 0 && (
                          <div className="table-responsive">
                                  ...
                                  <tr key={product.id}>
                                    ...
                                    <td>
                                      <input
                                        type="number"
                                        min="1"
                                        value={product.updatedQuantity} // Display the current shipping quantity
                                        onChange={(e) =>
                                          handleRetuenAcceptedQuantityChange(
                                            product.id,
                                            e.target.value
                                          )
                                        } // Handle changes
                            ...
                            <div>
                              Total accepted units :{" "}
                              <strong>{updatedTotalUnits}</strong>
                            </div>
                            <div>
                              Total Amount{" "}
...
export default ViewAcceptedReturn;
